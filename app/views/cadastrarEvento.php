...
<<<<<<< HEAD
        $endereco_imagem = 'assets/img/eventos/' . $banner['name'];
=======
        $endereco_banner = 'assets/img/atleticas/' . $banner['name'];
>>>>>>> 96a6865378a865b407aa902239bb918e5f40187a
        ...
        $query = "INSERT INTO eventos (id, titulo, descricao, data_inicio_evento, data_fim_evento, hora_inicio_evento, hora_fim_evento, data_inicio_insc_event, data_fim_insc_event,
        hora_inicio_insc_event, hora_fim_insc_event, banner, foto_1, foto_2, video, tipo_evento, endereco_evento, manager_user_id, nivel_user, user_ra, liberado) VALUES ('$id','$titulo',
        '$desc', '$dataInicioEvento', '$dataFimEvento', '$hrInicioEvento', '$hrFimEvento', '$dataInicioInsc', '$dataFimInsc', '$hrInicioInsc',
        '$hrFimInsc', '$endereco_imagem', '$endereco_foto1', '$endereco_foto2', '$endereco_video', '$tipoEvento', '$endereco', '$idUsr', '$nivelUsr', '$raUsr', 'NAO')";

...
<<<<<<< HEAD
        <?php if(!Controllers::isLogged()): echo'<button class="criar"><a href="login.php">Crie sua Atlética!</a></button><br>'; endif?>
=======
        <?php if(!Controllers::isLogged()): echo'<button class="criar"><a href="login.php">Crie um Evento</a></button><br>'; endif?>
